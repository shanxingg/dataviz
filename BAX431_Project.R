...
correlation_coef_IMDb <- round(cor(as.numeric(movie_1_no_outliers$IMDb_Rating), movie_1_no_outliers$Adjusted_Gross2),3) # correlation coefficient of IMDb_Rating
correlation_coef_MovieLens <- round(cor(as.numeric(movie_1_no_outliers$MovieLens_Rating), movie_1_no_outliers$Adjusted_Gross2),3) # correlation coefficient of MovieLens_Rating
...
# method2 - log-transform (not remove outliers)
# data cleaning
movie_1 <- movie
...
# Compute correlation coefficient
correlation_coef_Profit <- round(cor(movie_2_no_outliers$Runtime_min, movie_2_no_outliers$Profit2),3)
...
# Compute correlation coefficient
correlation_coef_Revenue <- round(cor(movie_2_no_outliers$Runtime_min, movie_2_no_outliers$Adjusted_Gross2),3)
...
# Compute correlation coefficient
correlation_coef_Budget <- round(cor(movie_2_no_outliers$Runtime_min, movie_2_no_outliers$Budget2),3)
...
# Compute correlation coefficient
correlation_coef_Compare <- round(cor(movie_3_no_outliers$US_rev2, movie_3_no_outliers$Overseas_rev2),3)
